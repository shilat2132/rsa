...
class AddBinary(Tm):
    ...
    def __init__(self, tapes):
        ...
        pos = []
        i1, i2 = getLastChar(tapes[0]), getLastChar(tapes[1]) #start from the lsb of the numbers
        pos.append(i1)
        pos.append(i2)
        pos.append(0)
        ...
        if len(tapes)== 3:  # Ensure there are 3 tapes
            tapes[2].clear()
        super().__init__(tapes, states, "q0", deltaTable, 3, pos)